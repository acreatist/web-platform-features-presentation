...
/*Using http://picturefill8.h011.attiks.com/core/modules/picture/picturefill/picturefill.js */
          ...
          for (var res = sources.length, r = res - 1; r >= 0; r-- ) {
            ...
            if (screenRes >= resMatch) {
              if (picImg.getAttribute('src') !== source[0]) {
                ...
                // originalâ€™s intrinsic width divided by the screen resolution.
              ...
              // Weâ€™ve matched, so bail out of the loop here.
              break;
            }
          }
        } else {
